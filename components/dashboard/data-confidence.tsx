...
export function DataConfidence({
  ...
  return (
    ...
    >
      ...
      <h2 id="data-confidence-title" className="module-title">
        Data Confidence
      </h2>
      ...
      <p className="mt-2 text-sm">
        <strong>{Math.round(averageCoverage)}%</strong> average team coverage
      </p>
      <dl className="mt-5 grid gap-3 text-sm">
        <div className="flex items-center justify-between gap-3">
          <dt className="flex items-center gap-2 text-[var(--ink-muted)]">
        ...
        <div className="flex items-center justify-between gap-3">
          <dt className="flex items-center gap-2 text-[var(--ink-muted)]">
            <TriangleAlert size={16} /> Missing metrics
          </dt>
          <dd>{missingMetricCount}</dd>
        </div>
        <div className="flex items-center justify-between gap-3">
          <dt className="flex items-center gap-2 text-[var(--ink-muted)]">
            <Gauge size={16} /> Eligibility
          </dt>
          <dd>{minimumMinutes} min</dd>
        </div>
        <div className="flex items-center justify-between gap-3">
          <dt className="flex items-center gap-2 text-[var(--ink-muted)]">
            <Microscope size={16} /> Method
          </dt>
          <dd>{methodologyVersion}</dd>
        </div>
      </dl>
    </section>
  );
