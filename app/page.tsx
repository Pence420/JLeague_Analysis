...
const TeamLandscape = dynamic(
  () =>
    import("@/components/charts/team-landscape-3d").then(
      (module) => module.TeamLandscape,
    ),
  {
    ssr: false,
    loading: () => (
      <div className="surface-card grid min-h-[540px] place-items-center text-sm text-[var(--ink-muted)]">
        Preparing interactive 3D landscape…
      </div>
    ),
  },
);
    ...
    <>
      ...
      <main className="mx-auto max-w-[1440px] px-4 pb-28 sm:px-7 md:pb-12">
        <ContextHeader
          ...
          onMinimumMinutesChange={dashboard.setMinimumMinutes}
        ...
        <div className="grid gap-3 xl:grid-cols-12">
          ...
          <div className="order-2 xl:col-span-5">
            <LeagueState
          ...
          <div className="order-3 xl:col-span-4">
            <PerformanceProcess items={viewModel.performanceProcess} />
          </div>
          <div className="order-4 xl:col-span-4">
            <SustainabilityWatch items={viewModel.sustainability} />
          </div>
          <div className="order-5 xl:col-span-4">
            <DataConfidence
          ...
          <div className="order-6 xl:col-span-8">
            <RecruitmentSignals items={viewModel.recruitmentSignals} />
          </div>
          <div className="order-7 xl:col-span-4">
            <RoleSupplyMap items={viewModel.roleSupply} />
          </div>
          <div className="order-8 xl:col-span-12">
        ...
        <footer className="mt-8 flex flex-wrap justify-between gap-3 border-t border-[var(--line)] py-6 text-xs font-semibold text-[var(--ink-muted)]">
          ...
          <span>SYNTHETIC SAMPLE DATA · NOT FOR RECRUITMENT DECISIONS</span>
        </footer>
      </main>
    </>
  );
